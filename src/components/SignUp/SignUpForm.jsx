...
const SignUpForm = ({ onSubmit }) => {
  ...
  return (
    <View style={styles.container}>
      ...
      <FormikTextInput name='passwordConfirmation' placeholder='Password confirmation' testId='passwordConfirmationInput' secureTextEntry/>
      <TouchableWithoutFeedback onPress={onSubmit} testID="signUpButton">
